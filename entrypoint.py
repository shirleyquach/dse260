...
def inference_mode(args):
    ...
    detector = Detector(
        ...
        args.scale_parameters_filepath,
    )
...
if __name__ == "__main__":
    ...
    inf_parser = subparser.add_parser(
        "infer", help="Execute container in inference mode for TrojAI detection."
    )
    ...
    configure_parser = subparser.add_parser(
        "configure",
        help="Execute container in configuration mode for TrojAI detection. This will produce a new set of learned parameters to be used in inference mode.",
    )
