...
if __name__ == "__main__":
    ...
    tlabel = 0
    with open(
        "./deltas/nin_trojan_dark_red_1_1_model_conv2d_7_135_64_0.pkl",
        "rb",
    ) as delta:
        rdelta = pickle.load(delta, encoding="latin1")
    with open(
        "./masks/nin_trojan_dark_red_1_1_model_conv2d_7_135_64_0.pkl",
        "rb",
    ) as mask:
        rmask = pickle.load(mask, encoding="latin1")
    rimg = imageio.imread(
